...
Grayscale Conversion: Isolates raw structural density maps.

Median Blur Filtering (kernel=5): Suppresses salt-and-pepper noise while preserving critical edge boundaries.

CLAHE (clipLimit=2.0, tileGridSize=(8,8)): Enhances local contrast to draw out subtle calcification features.

RGB Reconstruction: Converts the optimized matrices back to standard channels for YOLO processing.
